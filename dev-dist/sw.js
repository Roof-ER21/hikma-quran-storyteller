...
define(['./workbox-a35ba4eb'], (function (workbox) { 'use strict';
  ...
  workbox.registerRoute(/^https:\/\/cdn\.islamic\.network\/quran\/audio\/.*/i, new workbox.CacheFirst({
