...
START_URL=BASE_URL+'/#/quran'
SCRIPT_DIR=os.path.dirname(os.path.abspath(__file__))
OUT_DIR=os.path.join(SCRIPT_DIR,'results','local'); os.makedirs(OUT_DIR, exist_ok=True)
...
with sync_playwright() as p:
  ...
  for vp,w,h in VIEWPORTS:
    ...
    ctx.add_init_script("localStorage.setItem('alayasoad_language_selected','true'); localStorage.setItem('alayasoad_language','en'); localStorage.setItem('alayasoad_parent_token','a.b.c'); localStorage.setItem('alayasoad_parent_name','QA Parent');")
    page=ctx.new_page()
