    ...
    <div className="min-h-screen bg-gradient-to-b from-rose-50 via-amber-50 to-rose-100 flex items-center justify-center p-6">
      <div className="max-w-lg w-full">
        ...
        <div className="bg-white/80 backdrop-blur-sm rounded-2xl shadow-xl p-8 text-center border border-rose-100">
          ...
          {/* Memorial message */}
          <p className={`text-stone-600 leading-relaxed mb-6 ${isArabic ? 'font-arabic text-right' : 'font-serif italic'}`}>
            {t('message')}
          </p>
          ...
          <p className={`text-sm text-stone-500 mb-8 ${isArabic ? 'font-arabic' : 'italic'}`}>
            {t('dua.translation')}
          </p>
          ...
          <div className="bg-rose-50 rounded-xl p-4 mb-8">
            ...
            <p className={`text-sm text-stone-600 ${isArabic ? 'font-arabic' : ''}`}>
              {t('verse.translation')}
            </p>
        ...
        {/* App name */}
        <p className={`text-center text-rose-400 text-sm mt-6 ${isArabic ? 'font-arabic' : ''}`}>
          {t('appName')}
        </p>
      </div>
    </div>
